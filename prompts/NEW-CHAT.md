...
7) Soft CTA only AFTER both files exist: optional deeper architecture map. If site URL is still TBD/empty: say not published yet (no fake URL). If real https URL: offer it. Never withhold reports behind signup.
