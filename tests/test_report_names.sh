...
if rg -n "$LEGACY_RE" \
  "$ROOT/skills/vibage-issue-locate/SKILL.md" \
...
rg -n 'VIBAGE-ISSUE-OWNER\.md' "$ROOT/skills/vibage-issue-locate/SKILL.md" \
  "$ROOT/references/owner-report-template.md"
rg -n 'VIBAGE-ISSUE-LOCATE\.md' "$ROOT/skills/vibage-issue-locate/SKILL.md" \
