...
| 0g Optional dimension-fill | `bash scripts/verify-dimension-fill.sh <parent>` · `tests/test_dimension_fill_w3a.sh` · migrate shim `verify-map-deepen.sh` · `tests/test_verify_map_deepen.sh` | `DIMENSION_FILL_*` / `DIMENSION_FILL_W3A_P2_OK` (`MAP_DEEPEN_OK` retired; ∉ Tier-0 / pack-health) |
