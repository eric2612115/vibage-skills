...
| **W3a** | Spec: `…-dimension-fill-design.md` · Plan: `…-dimension-fill-p0.md` (**P0 On-tree**; `DIMENSION_FILL_W3A_P0_OK`) | P0 search+verify done; P1 orchestrator + P2 deepen-migrate open |
