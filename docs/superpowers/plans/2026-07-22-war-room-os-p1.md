...
**Files:** `scripts/install.sh`, `skills/war-room-init/SKILL.md`, `README.md`
...
**Files:** `assets/war-room-preview/index.html` and/or `scripts/serve-preview.sh`
...
> Product/spec Chat — **do not implement FE/BE in war-room-skills**. Skills stay free localize; soft CTA only; no invented prices.
...
- SEO/AI: sitemap, robots, hreflang, llms.txt, OG, JSON-LD, GA/GTM slots — follow `SelfAutoBuz/docs/research/war-room/ai-seo-exposure-stack-2026-07.md`.
...
2. `SelfAutoBuz/docs/research/war-room/INDEX.md`
3. `SelfAutoBuz/docs/research/war-room/ai-seo-exposure-stack-2026-07.md`
4. `war-room-web-design/DESIGN.md`
5. `war-room-web-design/tailwind-i18n-architecture.md`
6. `war-room-app/docs/API-FOR-FRONTEND.md` + `PRODUCT-LOCKS.md`
7. `war-room-skills/STATUS.md` (V0/P1 boundary — locate ≠ website)

### Spec / plan outputs (separate Chat 1)

| Deliverable | Path |
|-------------|------|
| Design spec | `SelfAutoBuz/docs/superpowers/specs/YYYY-MM-DD-war-room-web-shell-design.md` |
| Implementation plan | `SelfAutoBuz/docs/superpowers/plans/YYYY-MM-DD-war-room-web-shell.md` (after human approves spec) |
...
| Chat | Job | Repo focus |
|------|-----|------------|
| **Chat 2** | Web shell FE: locale routes, dictionary, theme, registry, login/302, SEO slots, read-only API seams | `war-room-web` / design package |
| **Chat 3** | Only API/auth gaps called out by the plan | `war-room-app` |
| **Chat 4** (optional) | Skills soft-CTA / NEW-CHAT URL pointers only if plan requires | `war-room-skills` (tiny; after P1 merge) |
...
- Finish **Chunk 6** (Tasks 16–20) before merging `feature/war-room-os-p1` when possible.
